...
<div class="wrap" id="wrap">
	<div class="logGet">
			...
			<div class="lgD">
			<img src="image/postbox.png" width="20" height="20" alt="" style="position:absolute; left:5px; top:30px; " />
				E-mail<input type="text" placeholder="输入邮箱" name="email"/>
			</div>
			<div class="logC">
				<a><input type=submit name="g" value="" style="border:0;"><button>找回密码</button></a>
